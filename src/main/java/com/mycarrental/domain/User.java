package com.mycarrental.domain;
...
public class User {
    ...
    private Boolean builtIn = false; //we dont want to change update user info


    //user ve roller arasinda baglantilari burada kurmus olduk
