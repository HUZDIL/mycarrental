...
import com.mycarrental.security.jwt.JwtUtils;
import com.mycarrental.service.UserService;
...
//burasi bizim disari ile baglantimizi sagliyor
@RestController
@Produces(MediaType.APPLICATION_JSON) //kullanici bilgileri json olarak donuyor
@AllArgsConstructor
@RequestMapping
public class UserController {
   ...
   @PreAuthorize("hasRole('CUSTOMER') or hasRole('ADMIN')")
    ...
    @PutMapping("/user/update") //burasi user di user update yaptim.
    @PreAuthorize("hasRole('CUSTOMER') or hasRole('ADMIN')")
